...
public abstract class CommandBase {
	...
	public CommandBase(List<String> commandDefinition, List<String> permissions, boolean strict)
	{
		Init(commandDefinition, permissions, ComputeAutomaticDefinition(commandDefinition), strict, null);
	}
